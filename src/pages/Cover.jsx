...
export default function Cover({ fadeOut }) {
  return( 
    <div
      className={`min-h-screen w-full bg-linkBlue flex items-center justify-center transition-opacity duration-700 ${
        fadeOut ? "opacity-0" : "opacity-100"
      }`}
    >
      {/* Mobile Container - Centered for Desktop */}
      <div className="relative p-0 w-[393px] h-[852px]  bg-linkBlue rounded-3xl m-0 overflow-hidden shadow-2xl">
